...
Process Admin {
	...
	[] not c.isEmpty(); Impresora[*]?siguiente(idImpresora) → Impresora[idImpresora]!hayDocumento(c.pop(idEmpleado, documento));
	od
}
```
## Ejercicio 2
...
### Respuestas:
//en papel lo tengo diferente pero honestamente no me acuerdo cuál fue el que corregí :D
```
...
### Respuestas:
//este tmb en papel lo tengo diferente pero honestamente no me acuerdo cuál fue el que corregí :D
```
